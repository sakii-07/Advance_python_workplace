...
SECRET_KEY = 'django-insecure-j2p+2ll++=-z(^bmo7d5a@t=y8--#wl6^@15+xtbfal%@qu65q'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR,"EmployeeApp/template")],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        ...
        'NAME': 'employee_maangement_system_db',
        'USER': 'root',
        'PASSWORD': 'root',
        'PORT':3306,
        'HOST': '127.0.0.1',
